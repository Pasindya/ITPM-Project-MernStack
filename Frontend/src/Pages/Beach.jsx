...
function Beach() {
  ...
  const [formData, setFormData] = useState({
    ...
    email: '',
    livingCountry: '',
    tpackage: 'Beach Paradise Getaway',
    arrivalDate: ''
  });
    ...
    <div style={styles.page}>
      ...
      <div style={styles.hero}>
        <div style={styles.heroContent}>
          <h1 style={styles.heroTitle}>Beach Paradise Getaway</h1>
          <p style={styles.heroSubtitle}>Relax on Sri Lanka's most beautiful tropical beaches</p>
          <button 
      ...
      <section style={{ margin: '40px 0' }}>
        <h2 style={{ textAlign: 'center', color: '#2c3e50', marginBottom: '20px' }}>About the Beach Getaway</h2>
        <p style={{ textAlign: 'center', maxWidth: '800px', margin: '0 auto' }}>
          Experience the ultimate beach vacation along Sri Lanka's stunning coastline. From golden sandy beaches to 
          thrilling water sports, this tour offers the perfect mix of relaxation and adventure.
        </p>
      </section>
      ...
      <div style={styles.destinationGrid}>
        ...
        >
          ...
          <div style={styles.cardContent}>
            <h3 style={{ color: '#2c3e50', marginBottom: '15px' }}>Mirissa</h3>
            <p>
              Famous for its golden beaches and whale watching opportunities, Mirissa offers a perfect blend of 
              relaxation and adventure. Enjoy stunning sunsets and vibrant beachside dining.
            </p>
          </div>
        </div>
        ...
        >
          ...
          />
          <div style={styles.cardContent}>
            <h3 style={{ color: '#2c3e50', marginBottom: '15px' }}>Unawatuna</h3>
            <p>
              This crescent-shaped beach with its calm turquoise waters is perfect for swimming and snorkeling. 
              The coral reefs just offshore make it an excellent spot for underwater exploration.
            </p>
          </div>
        </div>
        ...
        >
          ...
          />
          <div style={styles.cardContent}>
            <h3 style={{ color: '#2c3e50', marginBottom: '15px' }}>Bentota</h3>
            <p>
              Known as Sri Lanka's water sports capital, Bentota offers everything from jet skiing to windsurfing. 
              The area also features luxury resorts and the beautiful Bentota River for boat safaris.
            </p>
          </div>
        </div>
      </div>
      ...
      <section style={styles.itinerary}>
        ...
        <div style={styles.itineraryGrid}>
          <div style={styles.dayCard}>
            <h3 style={{ color: '#1abc9c', marginBottom: '15px' }}>Day 1-2: Arrival & Mirissa</h3>
            <ul style={{ paddingLeft: '20px' }}>
              <li style={{ marginBottom: '8px' }}>Arrival in Colombo</li>
              <li style={{ marginBottom: '8px' }}>Transfer to Mirissa</li>
              <li style={{ marginBottom: '8px' }}>Beach relaxation and whale watching</li>
              <li style={{ marginBottom: '8px' }}>Sunset beach dinner</li>
            </ul>
          </div>
          <div style={styles.dayCard}>
            <h3 style={{ color: '#1abc9c', marginBottom: '15px' }}>Day 3: Unawatuna</h3>
            <ul style={{ paddingLeft: '20px' }}>
              <li style={{ marginBottom: '8px' }}>Transfer to Unawatuna</li>
              <li style={{ marginBottom: '8px' }}>Snorkeling and swimming</li>
              <li style={{ marginBottom: '8px' }}>Visit Japanese Peace Pagoda</li>
            </ul>
          </div>
          <div style={styles.dayCard}>
            <h3 style={{ color: '#1abc9c', marginBottom: '15px' }}>Day 4-5: Bentota</h3>
            <ul style={{ paddingLeft: '20px' }}>
              <li style={{ marginBottom: '8px' }}>Water sports activities</li>
              <li style={{ marginBottom: '8px' }}>Boat safari on Bentota River</li>
              <li style={{ marginBottom: '8px' }}>Relaxation at luxury resort</li>
              <li style={{ marginBottom: '8px' }}>Return to Colombo for departure</li>
            </ul>
          </div>
        </div>
      </section>
        ...
        <div style={styles.popupOverlay}>
          <div style={styles.popupContainer}>
            ...
            <div style={styles.popupHeader}>
              <h2 style={{ color: '#2c3e50', marginBottom: '10px' }}>Book Your Beach Getaway</h2>
